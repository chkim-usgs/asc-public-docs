...
??? example "getExactTargetOrientations"
    ...
    === "REST"
        ...
        ```bash
        curl -XGET "https://astrogeology.usgs.gov/apis/spiceql/latest/getExactTargetOrientations?startEt=690201375.8323615&stopEt=690201389.2866975&toFrame=-74000&refFrame=-74690&exactCkFrame=-74400&mission=ctx&searchKernels=True"
        ```
    ...
    === "C++"
        ...
        ```c++
        SpiceQL::getExactTargetOrientations(690201375.8323615, 690201389.2866975, -74000, -74690, -74400 "ctx", true, true)
        ```
    ...
    === "Python"
        ...
        ([[690201375.8001044,
          ...
          [690201389.301267,
           ...
           0.0,
           0.0]],
         {'ck': ['mro/kernels/ck/mro_sc_psp_211109_211115.bc'],
          'ctx_ck_quality': 'reconstructed',
          'fk': ['mro/kernels/fk/mro_v17.tf'],
          'iak': ['mro/kernels/iak/mroctxAddendum005.ti'],
          'ik': ['mro/kernels/ik/mro_ctx_v11.ti'],
          'lsk': ['base/kernels/lsk/naif0012.tls'],
          'pck': ['odyssey/kernels/pck/pck00009.tpc', 'base/kernels/pck/pck00009.tpc'],
          'sclk': ['mro/kernels/sclk/MRO_SCLKSCET.00118.tsc',
           'mro/kernels/sclk/MRO_SCLKSCET.00118.65536.tsc'],
          'tspk': ['base/kernels/spk/de430.bsp']})
        ```
...
??? example "searchForKernelsets"
    ...
    === "REST"
        ...
        ```bash
        curl -XGET -g "https://astrogeology.usgs.gov/apis/spiceql/latest/searchForKernelsets?spiceqlNames=[mro]&types=[ck,spk,fk,sclk,pck,ik,iak,lsk,tspk]&limitCk=3"
        ```
        ⚠️ *Use `-g` or `--globoff` to treat brackets `[]` as literal characters instead of globbing.*
